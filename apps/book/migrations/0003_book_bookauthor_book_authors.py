    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('pr', 'programming'), ('ar', 'art'), ('hi', 'history'), ('po', 'politics'), ('ot', 'other')], default='pr', max_length=2)),
                ('published_date', models.IntegerField()),
                ('publisher', models.CharField(max_length=50)),
                ('lang', models.CharField(max_length=50)),
                ('edition', models.SmallIntegerField(blank=True, null=True)),
                ('book_format', models.CharField(choices=[('eb', 'ebook'), ('hc', 'hardcover')], default='eb', max_length=2)),
